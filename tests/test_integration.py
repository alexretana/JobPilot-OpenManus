...
def test_imports():
    ...
    try:
        ...
        from app.api.timeline import router, get_database_session
...
def test_database_connection():
    ...
    try:
        ...
        try:
            ...
            print(f"⚠️  Session creation failed (this is expected if DB is not initialized): {session_error}")
...
def test_timeline_dependency():
    ...
    try:
        ...
        import inspect
        assert inspect.isgeneratorfunction(get_database_session), "get_database_session should be a generator"
