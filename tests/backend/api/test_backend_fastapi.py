    ...
    try:
        ...
        with db_manager.get_session() as session:
            ...
            test_jobs = (
                ...
                .filter(JobListingDB.name.like("test_%"))
                .all()
            )
...
class TestJobCRUD:
    ...
    def test_create_job_success(
        self, client: TestClient, sample_job_data: Dict, clean_database
    ):
...
class TestJobSearchAndFiltering:
    ...
    @pytest.fixture
    def setup_multiple_jobs(
        self, client: TestClient, multiple_job_data: List[Dict], clean_database
    ):
    ...
    def test_semantic_search_endpoint(self, client: TestClient, setup_multiple_jobs):
        ...
        response = client.get(
            "/api/search/semantic", params={"query": "Python developer", "limit": 5}
        )
...
class TestStatisticsAndAnalytics:
    ...
    def test_job_market_insights(
        self, client: TestClient, multiple_job_data, clean_database
    ):
...
class TestPerformance:
    ...
    @pytest.mark.performance
    def test_bulk_job_creation_performance(
        self, client: TestClient, multiple_job_data, clean_database
    ):
        ...
        assert (
            response_time < 10.0
        )  # Should complete within 10 seconds for bulk operations

    @pytest.mark.performance
    def test_job_listing_performance(
        self, client: TestClient, multiple_job_data, clean_database
    ):
...
class TestIntegration:
    ...
    def test_complete_job_lifecycle(
        self, client: TestClient, sample_job_data, clean_database
    ):
