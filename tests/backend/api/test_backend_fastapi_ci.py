...
class TestHealthAndBasics:
    ...
    def test_api_status_endpoint(self, client: TestClient):
        ...
        apis = data["apis"]
        expected_apis = ["user_profiles", "timeline", "applications", "leads", "enhanced_jobs"]
...
class TestUserProfilesAPI:
    ...
    def test_create_user_profile(self, client: TestClient, sample_user_data: Dict, clean_database):
    ...
    def test_get_user_profile_by_id(self, client: TestClient, sample_user_data: Dict, clean_database):
    ...
    def test_get_user_profile_by_email(self, client: TestClient, sample_user_data: Dict, clean_database):
    ...
    def test_update_user_profile(self, client: TestClient, sample_user_data: Dict, clean_database):
    ...
    def test_delete_user_profile(self, client: TestClient, sample_user_data: Dict, clean_database):
...
class TestAPIErrorHandling:
    ...
    def test_create_user_duplicate_email(self, client: TestClient, sample_user_data: Dict, clean_database):
...
class TestAPIIntegration:
    ...
    def test_complete_user_lifecycle(self, client: TestClient, sample_user_data: Dict, clean_database):
