...
async def test_user_profiles_crud():
    ...
    try:
        ...
        UserProfile(**create_request.dict())
    ...
    try:
        ...
        print(
            f"   Job preferences configured: {len(final_user.preferred_job_types)} types, {len(final_user.preferred_remote_types)} remote types"
        )
