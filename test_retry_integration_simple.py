...
from app.data.models import JobListing, JobType, RemoteType, ExperienceLevel, JobStatus, VerificationStatus
...
def test_basic_database_retry_integration():
    ...
    updated_job = job_repo.update_job(str(result.id), {"description": "Updated description"})
