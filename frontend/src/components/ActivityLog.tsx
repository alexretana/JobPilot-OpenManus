...
const ActivityLog: Component<ActivityLogProps> = (props) => {
  ...
  return (
    <div class="card bg-base-100 shadow-xl h-full flex flex-col">
      <div class="card-header bg-info text-info-content p-4 rounded-t-xl">
      ...
      <div class="flex-1 p-4 overflow-y-auto scrollbar-thin min-h-0" style="max-height: 300px;">
        {props.activities().length === 0 ? (
          ...
          <div class="space-y-2">
            <For each={props.activities()}>
              {(activity) => (
                <div class={`activity-item ${activity.type} p-3 rounded-lg`}>
