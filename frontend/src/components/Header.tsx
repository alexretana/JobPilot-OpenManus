...
interface HeaderProps {
  ...
  activeTab?: () => 'chat' | 'jobs' | 'timeline';
  onTabChange?: (tab: 'chat' | 'jobs' | 'timeline') => void;
}
    ...
    <header class="navbar bg-base-100 shadow-lg sticky top-0 h-[5vh] z-50">
      ...
      <div class="navbar-end space-x-2">
        ...
        <div class="indicator">
          ...
          >
            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 323 512.53" fill="currentColor">
