          ...
          <div class="p-4 overflow-y-auto max-h-[calc(90vh-120px)]">
            ...
            <Show when={error()}>
              <div class="alert alert-error">
                ...
                <span>{error()}</span>
                <button class="btn btn-sm" onClick={() => props.jobId && loadJobDetails(props.jobId)}>
                  Try Again
                </button>
              </div>
            </Show>
            ...
            <Show when={!loading() && !error() && job()}>
              <div class="space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                  <Show when={job()?.requirements}>
                    <div>
                      ...
                      <div class="bg-base-200 rounded-lg p-3">
                        <pre class="whitespace-pre-wrap text-sm text-base-content/80 font-sans">{job()?.requirements}</pre>
                      </div>
                    </div>
                  </Show>
                  ...
                  <Show when={job()?.responsibilities}>
                    <div>
                      ...
                      <div class="bg-base-200 rounded-lg p-3">
                        <pre class="whitespace-pre-wrap text-sm text-base-content/80 font-sans">{job()?.responsibilities}</pre>
                      </div>
                    </div>
                  </Show>
                </div>
                ...
                {/* Skills */}
                <div class="grid md:grid-cols-2 gap-6">
                  <Show when={job()?.skills_required && (job()?.skills_required?.length ?? 0) > 0}>
                    <div>
                  ...
                  <Show when={job()?.skills_preferred && (job()?.skills_preferred?.length ?? 0) > 0}>
                    <div>
