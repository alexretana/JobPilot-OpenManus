...
const StatusPanel: Component<StatusPanelProps> = props => {
  ...
  return (
    <>
      {/* Drawer Overlay */}
      {props.isOpen() && (
        <div class='fixed inset-0 bg-black bg-opacity-50 z-40' onClick={() => props.onClose()} />
      )}

      {/* Right Drawer */}
      <div
        class={`fixed top-0 right-0 h-full w-80 bg-base-100 shadow-xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
          ...
          <div>
            ...
            <div class='stats stats-vertical shadow w-full'>
                ...
                <div class='stat-figure text-primary'>
                  <div
                    class={`avatar placeholder ${
                      webSocketService.getIsConnected()() ? 'online' : 'offline'
                    }`}
                  >
              ...
              <div class='stat'>
                ...
                <div class='stat-value text-sm'>{health()?.status || 'Unknown'}</div>
              </div>
            </div>
          </div>
              ...
              <div class='text-sm space-y-2'>
                ...
                <div class='flex justify-between'>
                  ...
                  <span class='font-medium text-right'>
                    {health()?.service || 'JobPilot-OpenManus'}
                  </span>
                </div>
                <div class='flex justify-between'>
                  <span>🔧 Tools:</span>
