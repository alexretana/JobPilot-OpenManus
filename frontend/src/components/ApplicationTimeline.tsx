...
export function ApplicationTimeline(props: ApplicationTimelineProps) {
  ...
  const getApplicationStatus = () => {
    ...
    if (events().some(e => e.event_type === TimelineEventType.OFFER_RECEIVED)) return 'Offer Received';
  ...
  const getStatusStyle = (status: string) => {
    ...
    if (lowerStatus.includes('applied') || lowerStatus.includes('submitted')) return 'badge-primary';
