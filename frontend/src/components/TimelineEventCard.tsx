  ...
  return (
    <div
      class={`card bg-base-100 shadow-sm border border-base-300 hover:shadow-md transition-shadow ${
        props.event.is_milestone ? 'ring-2 ring-primary ring-opacity-20' : ''
      }`}
    >
      <div class='card-body p-4'>
        ...
        <div class='flex items-start justify-between gap-3'>
          ...
          <div class='dropdown dropdown-end'>
            ...
            >
              <li>
                <button class='text-xs' onClick={() => setShowDetails(!showDetails())}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    class='h-3 w-3'
                    fill='none'
              ...
              <li>
                <button class='text-xs' onClick={() => setShowEditModal(true)}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    class='h-3 w-3'
                    fill='none'
              ...
              <li>
                <button class='text-xs text-error' onClick={handleDelete} disabled={deleting()}>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    class='h-3 w-3'
                    fill='none'
