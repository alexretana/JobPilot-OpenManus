...
from base_client import (
    JobAPIClient, JobSearchQuery, JobListing, RateLimitInfo, 
    JobSearchProvider, save_response_sample
)
import hashlib
    ...
    def transform_response(self, raw_response: Dict) -> List[JobListing]:
        ...
        for job_data in data:
            try:
                ...
                salary_min, salary_max, salary_currency = self._extract_salary_info(job_data)
        ...
        if "job_required_experience" in job_data:
            ...
            if isinstance(req, dict):
                ...
                if exp_required:
                    ...
                    requirements.append(f"Experience: {years} years" if years > 0 else "Experience required")
...
async def test_jsearch_api(api_key: str, query: str = "software engineer", location: str = "New York, NY"):
    ...
    async with JSearchClient(api_key) as client:
        try:
            ...
            print(f"  Rate limit: {rate_limits.requests_used}/{rate_limits.requests_per_month}")
