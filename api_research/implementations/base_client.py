...
class JobSearchQuery:
    ...
    job_requirements: Optional[List[str]] = None  # under_3_years_experience, more_than_3_years_experience, no_experience, no_degree
...
class JobAPIClient(ABC):
    ...
    async def _make_request(self, endpoint: str, params: Dict = None, headers: Dict = None) -> Dict:
    ...
    def get_usage_stats(self) -> Dict:
        ...
        return {
            ...
            "requests_per_minute": (self._request_count / elapsed_time) * 60 if elapsed_time > 0 else 0
        }

    async def test_connection(self, test_query: str = "software engineer") -> APITestResult:
...
def save_response_sample(provider: str, endpoint: str, response: Dict, query_params: Dict = None):
