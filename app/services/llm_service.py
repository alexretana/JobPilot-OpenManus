    ...
    async def generate_content(self, prompt: str, **kwargs) -> str:
        ...
        try:
            ...
            response = await self.client.chat.completions.create(
                model=self.model,
                messages=[
                    {"role": "system", "content": "You are an expert resume writer and career coach. Always respond with valid JSON when requested."},
        ...
        return json.dumps({
            "achievements": [
                ...
                },
                {
                    ...
                    "quantified_metrics": ["4 hours to 15 minutes", "zero-downtime"],
                    "keywords_used": ["CI/CD", "deployment", "automation"]
                }
            ],
            "suggested_variations": [],
            "missing_quantification_opportunities": ["Consider adding team size metrics"]
        })
    ...
    def _extract_json_from_text(self, text: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if start_idx != -1 and end_idx != -1 and end_idx > start_idx:
                ...
                return {"error": "Could not extract JSON from response", "raw_text": text}
