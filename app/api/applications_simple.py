...
from ..data.models import JobApplication, ApplicationStatus
from ..data.database import get_application_repository, get_job_repository, get_user_repository
...
def create_application(request: CreateApplicationRequest):
    ...
    try:
        ...
        app_data = JobApplication(
            ...
            applied_date=datetime.utcnow() if request.status == ApplicationStatus.APPLIED else None,
            notes=request.notes
        )
...
def update_application(
    ...
    try:
        ...
        if status is not None:
            ...
            if status == ApplicationStatus.APPLIED and "applied_date" not in update_data:
