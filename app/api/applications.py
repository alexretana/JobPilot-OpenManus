...
from ..data.models import (
    JobApplication, JobApplicationDB, ApplicationStatus, 
    JobListing, JobListingDB, UserProfile, UserProfileDB,
    TimelineEvent, TimelineEventType
)
from ..data.database import get_database_manager, get_application_repository, get_job_repository, get_user_repository
...
async def create_application(
    ...
    try:
        ...
        app_data = JobApplication(
            ...
            applied_date=request.applied_date or (
                datetime.utcnow() if request.status != ApplicationStatus.NOT_APPLIED else None
            ),
...
async def update_application(
    ...
    try:
        ...
        # Update application
        updated_app = await db.update_application(application_id, update_data)
