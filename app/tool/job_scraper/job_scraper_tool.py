...
class JobScraperTool(BaseTool):
    ...
    async def _run(
        ...
        try:
            ...
            scraped_jobs = await self._scrape_demo_jobs(query, location, job_type, max_results)
    ...
    async def _scrape_demo_jobs(self, query: str, location: str, job_type: str, max_results: int) -> List[Dict[str, Any]]:
        """
        ...
        tech_companies = [
            ...
            "Airbnb", "Uber", "Spotify", "Slack", "Zoom", "DocuSign", "Salesforce",
            "GitHub", "GitLab", "Atlassian", "Dropbox", "Square", "Stripe"
        ]
        ...
        job_titles = {
            ...
            "product": ["Product Manager", "Product Owner", "Product Designer", "UX Designer"],
            ...
            "mobile": ["iOS Developer", "Android Developer", "Mobile Developer", "React Native Developer"],
            "ai": ["AI Engineer", "Machine Learning Engineer", "AI Researcher", "Deep Learning Engineer"]
        }
        
        # Determine job category from query
        query_lower = query.lower()
        if "data" in query_lower or "ml" in query_lower or "machine learning" in query_lower:
            category = "data"
            ...
            category = "security"
        elif "mobile" in query_lower or "ios" in query_lower or "android" in query_lower:
            category = "mobile"
        ...
        for i in range(max_results):
            ...
            skills_map = {
                "software": ["Python", "JavaScript", "React", "Node.js", "SQL", "Git", "Docker"],
                "data": ["Python", "SQL", "Pandas", "NumPy", "Scikit-learn", "TensorFlow", "AWS"],
                "product": ["Figma", "Jira", "Analytics", "A/B Testing", "User Research", "Wireframing"],
                ...
                "ai": ["Python", "TensorFlow", "PyTorch", "Deep Learning", "NLP", "Computer Vision"]
            }
            
            skills_required = random.sample(skills_map.get(category, skills_map["software"]), 
                                          random.randint(3, 6))
            ...
            job_data = {
                ...
                "job_type": job_type,
                "remote_type": RemoteType.REMOTE if location == "Remote" else random.choice([RemoteType.ON_SITE, RemoteType.HYBRID]),
                ...
                "skills_preferred": random.sample(skills_map.get(category, skills_map["software"]), 2),
                "benefits": ["Health Insurance", "401(k)", "Remote Work", "Flexible Hours", "Professional Development"],
                "company_size": random.choice(["1-10", "11-50", "51-200", "201-500", "500-1000", "1000+"]),
                "industry": "Technology",
