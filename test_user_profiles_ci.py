...
async def test_user_profiles_crud():
    ...
    try:
        ...
        user_profile = UserProfile(**create_request.model_dump())
    ...
    try:
        ...
        print(f"  Job preferences: {len(final_user.preferred_job_types)} types, {len(final_user.preferred_remote_types)} remote")
        tests_passed += 1
